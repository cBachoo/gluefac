<script lang="ts">
    ...
    interface AppLink {
        ...
        name: string;
        url: string;
        iconType: "guide" | "tools" | "tracker" | "discord";
        description: string;
    }
    ...
    const apps: AppLink[] = [
        ...
        },
        {
            id: "drafter",
            name: "Drafter",
            url: "https://drafter.uma.guide",
            iconType: "tools",
            description: "Uma Drafter",
        },
        {
            id: "sparks",
            name: "Roster Viewer",
            url: "https://roster.uma.guide",
            iconType: "tracker",
            description: "Uma Sparks Viewer",
        },
        {
            id: "Discord",
            name: "Discord",
            url: "https://lighthello.com",
            iconType: "discord",
